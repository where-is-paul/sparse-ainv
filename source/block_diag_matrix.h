...
public:
  ...
  */
  ...
  /*!	\brief Solves the preconditioned problem |D| = Q|V|Q', where QVQ' is
  the eigendecomposition of D, and |.| is applied elementwise.
  ...
  */
  ...
  /*!	\brief Solves the system Dx = b.
              \param b the right hand side.
              \param x a storage vector for the solution (must be same size as
     b).
      */
  ...
  */
  ...
  /*! \param filename the filename of the matrix to be saved. All matrices saved
     are in matrix market format (.mtx).
